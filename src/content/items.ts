...
export const items: Record<ItemId, ItemDef> = {
  ...
  "creeper_eye": {
    "id": "creeper_eye",
    "name": "Creeper's Eye",
    "description": "A Warren Creeper's clouded eye, set in a copper band. It sees the gaps in a guard the way its owner saw pulses through stone. Dropped only in the Burrows of the Hunt Warrens.",
    "icon": "📿",
    "cat": "Jewellery",
    "slot": "necklace",
    "acc": 4,
  ...
  "stalker_fangs": {
    "id": "stalker_fangs",
    "name": "Stalker Fangs",
    "description": "A Dusk Stalker's twin fangs hafted into a whistling twin-blade. Faster than any smithed sword of its weight. Dropped only in the Dens of the Hunt Warrens.",
    "icon": "🗡️",
  ...
  "houndhide_cloak": {
    "id": "houndhide_cloak",
    "name": "Houndhide Cloak",
    "description": "The impossible hide of a Hollow Hound, tanned whole. Blades slide from it the way they slid from the hound. Dropped only in the Kennels of the Hunt Warrens.",
    "icon": "🧥",
    "cat": "Capes",
    "slot": "cape",
    "def": 9,
  ...
  "wraithbone_staff": {
    ...
    "lore": "bounty",
    "sell": 4200,
    "description": "A casting staff of fused wraithbone, cold in the hand and hungry for Grace. The finest channel in Varath — surrendered only by the Shades of the Warren Crypt."
  },
  "mawplate": {
    "id": "mawplate",
    "name": "Mawplate",
    "description": "A breastplate beaten from the Iron Maw's own shed plates. It has already survived everything once. Dropped only at the bottom of the Hunt Warrens.",
    "icon": "🛡️",
  ...
  // --- The Ascendant tier: the gear above every level ---------------------
  // Gated on MASTER STARS, not level, because level stops at 100 and this sits
  // above everything a level can reach. Forged only with Ascendant Embers, which
  // are minted by the post-max XP grind itself (see MASTERY_TIERS in worldCore).
  "ascendant_ember": {
      "id": "ascendant_ember",
      "name": "Ascendant Ember",
      "description": "A coal that will not go out. It is what tens of thousands of hours past mastery leaves behind — one is minted the first time a skill passes each master star, and nothing else in Varath makes another.",
      "icon": "🟠",
      "cat": "Materials",
      "sell": 0
  },
  "ascendant_helm": {
      "id": "ascendant_helm",
      "name": "Ascendant Helm",
      "description": "Hearthite worked around a living ember. The heat never reaches the wearer.",
      "icon": "⛑️",
      "cat": "Ascendant Armour",
      "slot": "helmet",
      "def": 62,
      "equipMastery": 3,
      "rarity": "legendary",
  ...
  "ascendant_body": {
      "id": "ascendant_body",
      "name": "Ascendant Cuirass",
      "description": "Plate that glows faintly along every seam, and stays cool to the touch.",
      "icon": "🛡️",
      "cat": "Ascendant Armour",
      "slot": "armor",
      "def": 84,
  ...
  "ascendant_legs": {
      ...
      "description": "The finest leg armour ever drawn from Varath, and the last — there is nothing above it to make.",
      "icon": "🦿",
      "cat": "Ascendant Armour",
      "slot": "legs",
      "def": 100,
  ...
  "ascendant_boots": {
      "id": "ascendant_boots",
      "name": "Ascendant Sabatons",
      "description": "They leave no mark on stone, and no heat behind them.",
      "icon": "🥾",
      "cat": "Ascendant Armour",
      "slot": "boots",
      "def": 30,
  ...
  "ascendant_shield": {
      "id": "ascendant_shield",
      "name": "Ascendant Bulwark",
      "description": "An ember set in hearthite, faced outward. Whatever strikes it arrives late.",
      "icon": "🛡️",
      "cat": "Ascendant Armour",
      "slot": "offhand",
      "def": 76,
  ...
  "ascendant_claymore": {
      "id": "ascendant_claymore",
      "name": "Ascendant Greatsword",
      "description": "A blade with an ember folded into the spine. It has never needed sharpening.",
      "icon": "⚔️",
      "cat": "Ascendant Weapons",
      "slot": "mainhand",
      "acc": 52,
      "dmg": 100,
      "attackStyle": "slash",
  ...
  "ascendant_spear": {
      "id": "ascendant_spear",
      "name": "Ascendant Spear",
      "description": "Perfectly balanced, and warm along its whole length. It goes exactly where it is sent.",
      "icon": "🗡️",
      "cat": "Ascendant Weapons",
      "slot": "mainhand",
      "acc": 98,
  ...
  "ascendant_maul": {
      "id": "ascendant_maul",
      "name": "Ascendant Maul",
      "description": "The head holds an ember the size of a fist. What it lands on does not get up.",
      "icon": "🔨",
      "cat": "Ascendant Weapons",
      "slot": "mainhand",
      "acc": 48,
  ...
  "ascendant_bow": {
      "id": "ascendant_bow",
      "name": "Ascendant Longbow",
      "description": "Deeproot around an ember core. The string hums after the arrow has already arrived.",
      "icon": "🏹",
      "cat": "Ascendant Weapons",
      "slot": "mainhand",
      "ranged": true,
  ...
  "ascendant_staff": {
      ...
      "description": "An ember caged at the head, burning on nothing. Grace pours through it without being asked.",
      "icon": "🔮",
      "cat": "Ascendant Weapons",
      "slot": "mainhand",
      "magic": true,
